...
export function HanukkahDecorations() {
  return (
    <div className="fixed inset-0 pointer-events-none overflow-hidden z-[1]">
      ...
      {/* Subtle blue and gold shimmer overlay */}
      <motion.div
        className="absolute inset-0 bg-gradient-to-br from-blue-400/5 via-transparent to-yellow-500/5"
        animate={{
          opacity: [0.3, 0.5, 0.3],
        }}
        transition={{
...
// Candle glow particles - slow and continuous with wobble
      ...
      {STABLE_PARTICLES.map((particle) => (
        <motion.div
          ...
          style={{
            ...
            background: "radial-gradient(circle, rgba(255,215,0,0.8) 0%, rgba(255,200,100,0.4) 50%, transparent 100%)",
            boxShadow: "0 0 4px 1px rgba(255,215,0,0.3)",
          }}
