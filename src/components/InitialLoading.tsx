...
export function InitialLoading() {
  return (
    <div
      className="flex h-screen w-screen items-center justify-center bg-gradient-to-br from-[#E0F2FE] via-[#F0F9FF] to-[#DBEAFE] dark:bg-none dark:bg-[#0B1120]"
      role="status"
      aria-label="טוען"
    >
      <div className="flex items-center gap-2">
        <svg
          className="h-5 w-5 animate-spin text-[#0284C7]"
        ...
        <span className="text-sm font-medium text-[#0284C7]" style={{ fontFamily: "var(--font-aran), sans-serif" }}>
          טוען...
        </span>
      </div>
    </div>
