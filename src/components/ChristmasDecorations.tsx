...
const STABLE_FLOATING_ELEMENTS = [
  { id: 0, emoji: "☕", left: 3, delay: 0, duration: 25, size: 16, wobble: [-30, 20, -25, 15, -20] },
  ...
  { id: 6, emoji: "🌟", left: 32, delay: 2, duration: 27, size: 16, wobble: [-35, 25, -20, 35, -25] },
  ...
  { id: 10, emoji: "🍪", left: 52, delay: 3.5, duration: 24, size: 14, wobble: [-15, 25, -30, 20, -25] },
  ...
  { id: 16, emoji: "🍩", left: 82, delay: 5.5, duration: 24, size: 14, wobble: [-20, 35, -25, 30, -15] },
