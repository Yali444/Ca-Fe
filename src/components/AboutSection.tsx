  ...
  return (
    <AuroraBackground className="h-full w-full" showRadialGradient={false}>
      ...
      <div className="w-full px-4 pt-16 pb-10 md:pt-10 md:pb-16 flex justify-center">
        ...
        >
          {/* Hero card */}
          <div className="rounded-3xl border border-white/40 dark:border-slate-700/50 bg-white/70 dark:bg-slate-800/70 backdrop-blur-xl p-8 shadow-xl text-center space-y-4">
          ...
          {/* About me */}
          <div className="rounded-3xl border border-white/40 dark:border-slate-700/50 bg-white/70 dark:bg-slate-800/70 backdrop-blur-xl p-7 shadow-xl space-y-4">
            <h2
          ...
          {/* Contact */}
          <div className="rounded-3xl border border-white/40 dark:border-slate-700/50 bg-white/70 dark:bg-slate-800/70 backdrop-blur-xl p-7 shadow-xl space-y-5">
            <h2
              className="text-lg font-semibold text-[#0C4A6E] dark:text-white"
              style={{ fontFamily: "var(--font-aran), sans-serif" }}
            >
